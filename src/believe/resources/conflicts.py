...
class ConflictsResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> ConflictsResourceWithRawResponse:
        ...
        """
        return ConflictsResourceWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> ConflictsResourceWithStreamingResponse:
        """
    ...
    def resolve(
        ...
        *,
        ...
        Args:
          ...
          parties_involved: Who is involved in the conflict

          attempts_made: What you've already tried
...
class AsyncConflictsResource(AsyncAPIResource):
    ...
    def with_raw_response(self) -> AsyncConflictsResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/cjavdev/believe-python#accessing-raw-response-data-eg-headers
        """
        return AsyncConflictsResourceWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncConflictsResourceWithStreamingResponse:
        """
        An alternative to `.with_raw_response` that doesn't eagerly read the response body.
