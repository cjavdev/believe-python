...
class ReframeResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> ReframeResourceWithRawResponse:
        ...
        """
        return ReframeResourceWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> ReframeResourceWithStreamingResponse:
        """
    ...
    def transform_negative_thoughts(
        ...
        *,
        ...
        Args:
          ...
          recurring: Is this a recurring thought?
...
class AsyncReframeResource(AsyncAPIResource):
    ...
    def with_raw_response(self) -> AsyncReframeResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/believe-python#accessing-raw-response-data-eg-headers
        """
        return AsyncReframeResourceWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncReframeResourceWithStreamingResponse:
        """
        An alternative to `.with_raw_response` that doesn't eagerly read the response body.
...
class ReframeResourceWithRawResponse:
    def __init__(self, reframe: ReframeResource) -> None:
        ...
        self.transform_negative_thoughts = to_raw_response_wrapper(
...
class AsyncReframeResourceWithRawResponse:
    def __init__(self, reframe: AsyncReframeResource) -> None:
        ...
        self.transform_negative_thoughts = async_to_raw_response_wrapper(
            reframe.transform_negative_thoughts,
        )
...
class AsyncReframeResourceWithStreamingResponse:
    def __init__(self, reframe: AsyncReframeResource) -> None:
        ...
        self.transform_negative_thoughts = async_to_streamed_response_wrapper(
            reframe.transform_negative_thoughts,
        )
