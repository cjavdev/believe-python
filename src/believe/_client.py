...
if TYPE_CHECKING:
  ...
  from .resources import believe
  from .resources import conflicts
  from .resources import reframe
  from .resources import press
  from .resources import coaching
  from .resources import biscuits
  from .resources import pep_talk
  from .resources import stream
  from .resources import team_members
  from .resources import webhooks
  from .resources import ticket_sales
